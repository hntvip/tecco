...
(function (e, t, n, r) {
    function u(t, n) {
        o = e.extend({}, s, n);
        if (o.formKey) {
            o["url"] = "https://docs.google.com/forms/d/e/" + o.formKey + "/viewform?embedded=true"
        }
    }
    var i = "jqGoogleForms",
        s = {},
    ...
    e.fn[i]().sendFormData = function (t) {
        if (o.formKey) {
            e.ajax({
                url: "https://docs.google.com/forms/d/e/" + o.formKey + "/formResponse",
                data: t,
                type: "POST",
                dataType: "xml"
            })
