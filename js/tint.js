...
$(function () {
    ...
    $(".bt-register-price").click(function () {
        $(".register-price").toggleClass("open")
    });

    $(".bt-menu-controls").click(function () {
        $(".menu-controls").toggleClass("open")
    });

    $(".bt-search").click(function () {
        $(".ls-controls").toggleClass("close");
        $(".wrap-search").toggleClass("show");
        $('.wrap-search .txtsearch').focus();
    });
...
function init_map(mapid) {
    var contentString = $(".lbl_hado_address").html();
...
function Valid_Contact(name, msgname, lblname,
    ...
    //Mobile
    if (regex_phone.test(ctrMobile.val()) || ctrMobile.val() == "" || ctrMobile.val() == lblmobile) { $(ctrMobile).addClass('error'); error += bl + msgmobile + br; }
